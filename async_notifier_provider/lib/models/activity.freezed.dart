...
mixin _$Activity implements DiagnosticableTreeMixin {
 ...
 String get activity; String get type; int get participants; double get price;// required String link,
 String get key; double get accessibility;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('activity', activity))..add(DiagnosticsProperty('type', type))..add(DiagnosticsProperty('participants', participants))..add(DiagnosticsProperty('price', price))..add(DiagnosticsProperty('key', key))..add(DiagnosticsProperty('accessibility', accessibility));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String activity,  String type,  int participants,  double price,  String key,  double accessibility)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Activity() when $default != null:
return $default(_that.activity,_that.type,_that.participants,_that.price,_that.key,_that.accessibility);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String activity,  String type,  int participants,  double price,  String key,  double accessibility)  $default,) {final _that = this;
switch (_that) {
case _Activity():
return $default(_that.activity,_that.type,_that.participants,_that.price,_that.key,_that.accessibility);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String activity,  String type,  int participants,  double price,  String key,  double accessibility)?  $default,) {final _that = this;
switch (_that) {
case _Activity() when $default != null:
return $default(_that.activity,_that.type,_that.participants,_that.price,_that.key,_that.accessibility);case _:
  return null;
